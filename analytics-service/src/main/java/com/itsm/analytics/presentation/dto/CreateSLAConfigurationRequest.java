...
/**
 * Request DTO for creating SLA configuration
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CreateSLAConfigurationRequest {
    
    @NotBlank(message = "Catégorie est obligatoire")
    private String categorie;
    
    @NotBlank(message = "Priorité est obligatoire")
