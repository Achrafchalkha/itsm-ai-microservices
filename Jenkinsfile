                ...
                script {
                    withCredentials([
                        ...
                        dir('terraform') {
                            ...
                            bat 'cmd /c "set TF_CLI_ARGS=-var=client_id=%CLIENT_ID% -var=client_secret=%CLIENT_SECRET% && C:\\Users\\LENOVO\\AppData\\Local\\Microsoft\\WinGet\\Links\\terraform.exe plan -out=tfplan"'
